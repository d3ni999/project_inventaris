          ...
          <div class="box-header">
            ...
            <div class="btn-group pull-right">
              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_suplier">
               <i class="fa fa-plus"></i> &nbsp Tambah Supplier Baru
             </button>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <h4 class="modal-title">Supplier Baru</h4>
                ...
                <div class="modal-body">
                  <form action="suplier_act.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama" required="required" placeholder="Masukkan Nama Supplier..">
                    </div>
